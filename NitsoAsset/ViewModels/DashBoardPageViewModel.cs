    ...
    public class DashBoardPageViewModel : ViewModel
    {
        ...
        public async void BindData()
        {
            try
            {
                ...
                tempDashboardItems.Add(new DashboardModel() { Title = "Asset Code", BgColor = Color.FromHex("#003f4e"), DashboardNavType = DashboardEnums.ASSETCODE });
                ...
                tempDashboardItems.Add(new DashboardModel() { Title = "Verify", BgColor = Color.FromHex("#003f4e"), DashboardNavType = DashboardEnums.VERIFY });
                tempDashboardItems.Add(new DashboardModel() { Title = "Add Asset", BgColor = Color.FromHex("#003f4e"), DashboardNavType = DashboardEnums.ADDASSET });
                tempDashboardItems.Add(new DashboardModel() { Title = "Asset List", BgColor = Color.FromHex("#003f4e"), DashboardNavType = DashboardEnums.ASSETLIST });
        ...
        public async void DashboardItemTap(DashboardModel model)
        {
            try
            {
                ...
                {
                    await RuntimePermission.RuntimePermissionStatus(Plugin.Permissions.Abstractions.Permission.Camera);
